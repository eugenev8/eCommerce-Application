...
const itemList = [
  {
    id: '1',
    img: 'https://m.media-amazon.com/images/I/71ZAeHYYlHL._AC_SL1500_.jpg',
    model: 'Apple macbook',
    specs: 'RAM: 16 Diagonal: 14.2 HDD: 512 OS: macOS CPU: M2 Max',
    price: '$1299.00',
    quantity: '1',
    subtotalPrice: '$1299.00',
  },
  {
    id: '2',
    img: 'https://m.media-amazon.com/images/I/71ZAeHYYlHL._AC_SL1500_.jpg',
        ...
        <div className={styles.container__items}>
          ...
          {itemList.map((item) => (
            <div key={item.id} className={styles.basket__item}>
              ...
              <div className={styles.quantity}>
                <input key="quantity" type="number" placeholder={item.quantity} min={0} />
              </div>
              <div key="subtotal">{item.subtotalPrice}</div>
          ...
          <div className={styles.cartControls}>
            <div className="leftButtons">
              ...
              <button className={styles.buttonBlack} type="button" onClick={() => clearCartHandler()}>
                Clear Shopping Cart
              </button>
            </div>
            <div className="rightButtons">
              <button className={styles.buttonBlack} type="button" onClick={() => updateCartHandler()}>
